...
>(({ className, variant = 'default', ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      variant === 'glass' &&
        'glass-base border-white/20 data-[state=checked]:bg-primary/30 data-[state=unchecked]:bg-white/10',
      className,
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        variant === 'glass' && 'bg-white shadow-[0_0_15px_rgba(255,255,255,0.3)]',
      )}
    />
  </SwitchPrimitives.Root>
))
